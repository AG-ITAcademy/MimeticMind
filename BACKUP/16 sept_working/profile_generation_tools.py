...
def generate_profile(session):
    ...
    profile = Profile(
        ...
        llm_persona=None,       # You may generate this separately
        llm_typical_day=None    # You may generate this separately
    )
...
def _select_weighted_value(session, category):
    ...
    choices = [row[0] for row in weights]        # row[0] is the 'value'
    probabilities = [row[1] for row in weights]  # row[1] is the 'percentage'
